...
# %%
gpt2_small.cfg
print("Number of layers: {}".format(gpt2_small.cfg.n_layers))
print("Number of heads per layer: {}".format(gpt2_small.cfg.n_heads))
print("Maximum context window: {}".format(gpt2_small.cfg.n_ctx))
...
prediction
# %%
actual_tokens = gpt2_small.to_tokens(model_description_text)
# %%
